                        ...
                        <tr>
                            ...
                            <td align="center">
                                <div style="display: flex; flex-direction: column; gap: 5px; align-items: center;">
                                    <a href="edit_aspirasi.php?id=<?php echo $aspirasi['id_pelaporan']; ?>" class="btnn" style="padding: 8px 20px; text-decoration: none; width: 100%; text-align: center;">Jawab</a>
                                    <a href="proses_hapus.php?idt=<?php echo $aspirasi['id_pelaporan']; ?>" class="btn-delete-red" style="width: 100%; text-align: center; margin-bottom: 0;" onclick="return confirm('Yakin hapus aspirasi ini?')">Hapus</a>
                                </div>
                            </td>
                        </tr>
                        <?php endwhile; ?>
